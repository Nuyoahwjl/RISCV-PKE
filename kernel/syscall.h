...
// challenge syscalls
#define SYS_user_print_backtrace (SYS_user_base + 7)
#define SYS_user_better_malloc (SYS_user_base + 8)
#define SYS_user_better_free (SYS_user_base + 9)
#define SYS_user_sem_new (SYS_user_base + 10)
#define SYS_user_sem_P (SYS_user_base + 11)
#define SYS_user_sem_V (SYS_user_base + 12)
#define SYS_user_sem_free (SYS_user_base + 13)
#define SYS_user_printpa (SYS_user_base + 14)
#define SYS_user_rcwd (SYS_user_base + 15)
#define SYS_user_ccwd (SYS_user_base + 16)
