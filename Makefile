...
USER_APP_SRCS := $(addprefix user/,$(addsuffix .c,$(USER_APPS)))
USER_CPPS := $(USER_APP_SRCS) user/user_lib.c
USER_OBJS := $(addprefix $(OBJ_DIR)/, $(patsubst %.c,%.o,$(USER_CPPS)))
USER_TARGETS := $(addprefix $(HOSTFS_ROOT)/bin/,$(USER_APPS))
...
$(HOSTFS_ROOT)/bin/%: $(UTIL_LIB) $(OBJ_DIR)/user/%.o $(OBJ_DIR)/user/user_lib.o | $(OBJ_DIR)
	@echo "linking" $@ ...
	-@mkdir -p $(HOSTFS_ROOT)/bin
	@$(COMPILE) --entry=main $(OBJ_DIR)/user/$*.o $(OBJ_DIR)/user/user_lib.o $(UTIL_LIB) -o $@
